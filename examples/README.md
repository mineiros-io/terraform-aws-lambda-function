...
- [python-function/] Deploy a simple Python Function to AWS Lambda.

<!-- References -->
<!-- markdown-link-check-disable -->
[python-function/]: https://github.com/mineiros-io/terraform-aws-lambda-function/blob/master/examples/python-function
